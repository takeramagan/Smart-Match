...
export const DK_CONTACT_US = 'andrew@metisign.com';
...
export const APP_END_POINT =
    process.env.ENV_FLAG === 'production' ?
        ...
        "https://production-api.smartmatch.app/koios/v1/market_value/" :
...
// export const APP_END_POINT_METISIGN =
//     process.env.ENV_FLAG === 'production' ?
//         'https://production-history-reports.metisign.com/' :
//         'https://staging-history-reports.metisign.com/'
